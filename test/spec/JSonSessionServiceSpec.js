describe("Manage Session with Json format", function () {
    describe("export session to Json", function () {
        it("should export every session data to JSon format", function () {
            ...
            session.addCharter(new Charter("Add Charter"));
            ...
            //debugger;
            var expectedJSon = "{\"BrowserInfo\":\"TestBrowser 10.0.1.3\",\"StartDateTime\":\"2015-11-30T06:51:00.000Z\",\"annotations\":[{\"type\":\"Charter\",\"name\":\"Add Charter\"},{\"type\":\"Bug\",\"name\":\"Add Bug\",\"URL\":\"http://TestSite/bugUrl.com\",\"timeStamp\":\"2015-10-30T08:00:00.000Z\"},{\"type\":\"Idea\",\"name\":\"Add Idea\",\"URL\":\"http://TestSite/IdeaUrl.com\",\"timeStamp\":\"2015-10-30T08:05:00.000Z\"},{\"type\":\"Note\",\"name\":\"Add Note\",\"URL\":\"http://TestSite/NoteUrl.com\",\"timeStamp\":\"2015-10-30T08:10:00.000Z\"},{\"type\":\"Question\",\"name\":\"Add Question\",\"URL\":\"http://TestSite/QuestionUrl.com\",\"timeStamp\":\"2015-10-30T08:15:00.000Z\"}]}"
    ...
    it("should export session with no annotations", function () {
        ...
        var expectedJSon = "{\"BrowserInfo\":\"TestBrowser 10.0.1.3\",\"StartDateTime\":\"2015-11-30T06:51:00.000Z\",\"annotations\":[]}"
        var JSONService = new JSonSessionService();
        var actualJson = JSONService.getJSon(session);
...
describe("import session from Json", function () {
    it("should create a session object from json with no annotations", function () {
        var JSonString = "{\"BrowserInfo\":\"TestBrowser 10.0.1.3\",\"StartDateTime\":\"2015-11-30T06:51:00.000Z\",\"annotations\":[]}";
    ...
    it("should create a session object from json with many annotations", function () {
        var JSonString = "{\"BrowserInfo\":\"TestBrowser 10.0.1.3\",\"StartDateTime\":\"2015-11-30T06:51:00.000Z\",\"annotations\":[{\"type\":\"Bug\",\"name\":\"Add Bug\",\"URL\":\"http://TestSite/bugUrl.com\",\"timeStamp\":\"2015-10-30T08:00:00.000Z\"},{\"type\":\"Idea\",\"name\":\"Add Idea\",\"URL\":\"http://TestSite/IdeaUrl.com\",\"timeStamp\":\"2015-10-30T08:05:00.000Z\"},{\"type\":\"Note\",\"name\":\"Add Note\",\"URL\":\"http://TestSite/NoteUrl.com\",\"timeStamp\":\"2015-10-30T08:10:00.000Z\"},{\"type\":\"Question\",\"name\":\"Add Question\",\"URL\":\"http://TestSite/QuestionUrl.com\",\"timeStamp\":\"2015-10-30T08:15:00.000Z\"}]}";
...
describe("Export and import sesion", function () {
